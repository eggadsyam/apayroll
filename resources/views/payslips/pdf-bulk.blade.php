...
<head>
    <meta charset="utf-8">
    <title>Slip Gaji Massal - {{ $period->name }}</title>
    <style>
        ...
        <table style="border: none;">
            <tr>
                <td style="width: 48%; vertical-align: top;" class="box">
                    ...
                    <div class="total-row"><table style="border:none;"><tr><td>Total Penghasilan</td><td class="text-right">Rp{{ number_format($payroll->gross_salary, 0, ',', '.') }}</td></tr></table></div>
                </td>
                <td style="width: 4%;"></td>
                <td style="width: 48%; vertical-align: top;" class="box">
                    ...
                    <div class="total-row"><table style="border:none;"><tr><td>Total Potongan</td><td class="text-right">Rp{{ number_format($payroll->total_deduction, 0, ',', '.') }}</td></tr></table></div>
                </td>
            </tr>
        </table>

        <div class="thp-box"><strong>TAKE HOME PAY : Rp{{ number_format($payroll->net_salary, 0, ',', '.') }}</strong></div>
        
        <table class="signature">
            <tr>
                <td class="sig-col" style="width: 50%;">
                    <div>Penerima,</div><div class="sig-space"></div><div><strong>{{ $payroll->employee->name }}</strong></div>
                </td>
                <td class="sig-col" style="width: 50%;">
                    <div>Mengetahui,</div><div class="sig-space"></div><div><strong>HR / Finance</strong></div>
                </td>
            </tr>
        </table>
    </div>
